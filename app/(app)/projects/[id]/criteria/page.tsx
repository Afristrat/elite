  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h1 className="text-xl font-bold text-on-surface mt-2">Critères d&apos;évaluation</h1>
      ...
      {['decided', 'archived'].includes(project.status) && (
        <div className="bg-na-secondary-container/20 border border-na-secondary/30 rounded-xl p-4">
          <p className="text-na-secondary text-sm font-medium">Projet décidé — lecture seule recommandée</p>
          <p className="text-na-on-secondary-container/60 text-xs mt-1">
